// Version 0.2.5.1:   Stammverzeichniserkennung hinzugefügt; Überprüfung aller Einstellungen
// Version 0.2.5.0:   Erkennung des Transfertyps neu geschrieben; Ausgaben für Tranfers mit 2+ Dateien hinzugefügt
// Version 0.2.4.3:   Endung AESHELL bei verschlüsselten Dateitransfers entfernen
// Version 0.2.4.2:   Überprüfung der Korrektheit des Dateipfades in der Variable "empfangsdateipfad"
// Version 0.2.4.1:   Erkennung von absolutem Dateifpad in Variable "empfangsdateipfad"
// Version 0.2.4.0:   Icons für diverse Dateitypen hinzugefügt
// Version 0.2.3.1:   Pfade können nun in der Config.js angepasst werden
...
// Version 0.2.1.5:   Class Link-Foto + Class Link-Foto2 ersetzt durch Class Imagebox + Imagebox2; Class Otherbox eingeführt
// Version 0.2.1.4:   Eigene Icons für Dateiempfang
// Version 0.2.1.3:   Ordnerlink für gesendete Nachrichten eingebracht
// Version 0.2.1.2:   Aufklappbare Bereiche eingebracht, Parameter UIN hinzugefügt, Links haben eine class erhalten
...
function getandsenddata(eingangsmeldung,chatpartner,basispfad,uinchatpartner,cid) {    
  ...
  //Endung von verschlüsselten Dateitransfers abschneiden
  ...
  switch (transfertyp) {
  case 'ausgehend':
    //Pfadermittlung für ausgehende Transfers
    ...
    document.write('Datei [<a class="Link-Text" onmouseout="this.className=\'Link-Text\';" onmouseover="this.className=\'Link-Text2\';" href="'+datei +'" title="'+ datei +'">'+ dateiname +'</a>] aus Ordner [<a class="Link-Text" onmouseout="this.className=\'Link-Text\';" onmouseover="this.className=\'Link-Text2\';" href="'+ dateipfad +'" title="'+ dateipfad +'">'+ dateipfadkurz +'</a>] gesendet');   
  break;
  case 'eingehend':
    //Pfadermittlung für eingehende Transfers
    ...
    document.write('<div id="'+randomid+'button" class="imagebox_filetransfer"></div>&nbsp;');
    document.write('Datei [<a class="Link-Text" onmouseout="this.className=\'Link-Text\';" onmouseover="this.className=\'Link-Text2\';" href="'+datei +'" title="'+datei +'">'+ dateiname +'</a>] von ');
    document.write('<a class="Link-Text" onmouseout="this.className=\'Link-Text\';" onmouseover="this.className=\'Link-Text2\';" class="textlink" href="'+chatpartnerordner+'" title="'+chatpartnerordner+'">'+chatpartner+' ('+uinchatpartner+')</a> erhalten bzw. ist empfangsbereit! ');
  break;
  case 'multiausgehend':
    //Pfadermittlung für ausgehende Transfers mit 2+ Dateien
    chatpartnerordner = chatpartnerordner.substring(7,chatpartnerordner.length);  
    chatpartnerordner = chatpartnerordner.replace(/\//g, '\\'); 
    var datei = chatpartnerordner+'\\';   
    var dateianzahl = emeldung; 
    document.write('<div id="'+randomid+'button" class="imagebox_filetransfer"></div>&nbsp;');
    document.write(dateianzahl +' an ');
    document.write('<a class="Link-Text" onmouseout="this.className=\'Link-Text\';" onmouseover="this.className=\'Link-Text2\';" class="textlink" href="'+chatpartnerordner+'" title="'+chatpartnerordner+'">'+chatpartner+' ('+uinchatpartner+')</a> gesendet ');
  break;  
  case 'multieingehend':
    //Pfadermittlung für ausgehende Transfers mit 2+ Dateien
    chatpartnerordner = chatpartnerordner.substring(7,chatpartnerordner.length);  
    ...
    var datei = chatpartnerordner+'\\';  
    var dateianzahl = emeldung;
    //Workaround für 'Files' anstatt 'Dateien' 
    dateianzahl = dateianzahl[0].replace('Files','Dateien');    
    document.write('<div id="'+randomid+'button" class="imagebox_filetransfer"></div>&nbsp;');
    document.write(dateianzahl +' von ');
    document.write('<a class="Link-Text" onmouseout="this.className=\'Link-Text\';" onmouseover="this.className=\'Link-Text2\';" class="textlink" href="'+chatpartnerordner+'" title="'+chatpartnerordner+'">'+chatpartner+' ('+uinchatpartner+')</a> erhalten ');   
  break;
  default:
  break;
  }
  
  //Ab hier steht die Variable 'datei' zur Verfügung, hier drin befindet sich der Dateiname mit der gesamten Pfadangabe

  //Der Dateityp wird bestimmt und ein entsprechendes Icon ausgewählt
  ...
  for (i=0; i<bildendungen.length; i++) {
    if (eingangsmeldung.search(bildendungen[i]) != -1 ) {
      bildpfad = datei;
      ausgabe = '<img src="'+iconpfad+icon+'" class="icons_filetypes" onmouseover="src=\''+iconpfad+icon_d+'\';" onmouseout="src=\''+iconpfad+icon+'\';" onmousedown="picturearea(document.getElementById(\''+randomid+'pic\'),this.alt)" title="Bildbereich anzeigen/ausblenden" alt="'+datei+'[trenn]'+bildpfad+'[trenn]'+randomid+'">';
  ...
  for (i=0; i<videoendungen.length; i++) {
    if (eingangsmeldung.search(videoendungen[i]) != -1 ) {
      ...
      ausgabe = '<img src="'+iconpfad+icon+'" class="icons_filetypes" onMouseOver="src=\''+iconpfad+icon_d+'\'" onMouseOut="src=\''+iconpfad+icon+'\'" onmousedown="videoarea(document.getElementById(\''+randomid+'div\'),this.alt,0)" title="Videobereich anzeigen/ausblenden" alt="'+datei+'[trenn]'+randomid+'">';
      document.getElementById(randomid+'button').innerHTML=ausgabe;
