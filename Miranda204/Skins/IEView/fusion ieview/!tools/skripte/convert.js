// Version 0.3.0.8:   Popupbildvorschau für Videos gefixt
// Version 0.3.0.7:   Variable "alleurlsalsbild" durch die Variable "vorschaupopup" ersetzt; 
// Version 0.3.0.6:   seitenumwandlung als Funktionsparameter hinzugefügt 
...
// Version 0.3.0.3:   Variable "vorschaubuttonposi" in "vorschaubuttonstatus" umbenannt und Wertebereich verändert
// Version 0.3.0.2:   Veränderung der Auswahl bei "alleurlsalsbild"
...
// Version 0.2.2.4:   Für Videos nun 2 Buttons: 1. Popupbereich öffnen - 2. Videobereich öffnen/schließen
// Version 0.2.2.3:   Einstellung für Popupvorschau in die CSS gewandert; Abfrage nach SWF Umwandlung (ja/nein) eingebracht (ACHTUNG: Anpassung in der Basicfile.js nötig)
// Version 0.2.2.2:   Problem mit RESET des Seitenverhältnises gefixt
...
// Version 0.2.1.3:   Standardcursor und Linkcursor per CSS veränderbar
// Version 0.2.1.2:   Icons vor und hinter dem Link werden nun per CSS veränderbar
// Version 0.2.1.1:   Iconsveränderung per CSS eingefügt
...
function linkconvert(text,bildumwandlung,videoumwandlung,swfumwandlung,seitenumwandlung) {
 ...
 text = text.replace(/<br>/g,' yyx ');       //1. Anweisung der if-Anweisung entfernt alle Umbrüche
  ...
  for (j=1; j<hrefsplit.length;j++) {
    ...
    if ((videoumwandlung == 'yes') && (gefunden=="undefiniert") && (window.videoplay)) {
      //(window.videoplay) schaut nach ob die Function VIDEOPLAY existiert, wenn nicht wird diese IF-Anweisung übersprungen, daraus folgt: ALLE Videolinkseiten werden als normale Seiten behandelt
  ...
  ausgabe = ausgabe.replace(/ yyx /g,'<br>'); //letzte Anweisung der If-Anweisung erstellt wieder die Umbrüche
  return ausgabe;
}