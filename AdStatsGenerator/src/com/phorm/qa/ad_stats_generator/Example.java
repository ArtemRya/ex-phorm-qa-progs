...
public class Example {
	...
	Sequence sequence = new Sequence(AdColo.Host.STAGE, AdColo.Cluster.CENTRAL);
	sequence.setLogger(new SimpleLogger(LoggerUtil.getFileLogger("SequenceLogger", "logs\\Example.log")));
